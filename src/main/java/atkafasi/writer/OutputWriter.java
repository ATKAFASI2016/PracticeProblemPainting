...
public class OutputWriter {
    ...
    public static void generateAsciiImage(String fileName, ParseResultPojo frameData, List<Instructions> instructionsList) throws IOException, IllegalInstructionFound {
        ...
        try (BufferedWriter bw = new BufferedWriter(fw)) {
            ...
            for (Instructions instruction : instructionsList) {
                ...
                if (instruction instanceof Square) {
                    ...
                    if (!checkValidity) {
                        throw new IllegalInstructionFound("INVALID INSTRUCTION FOUND ! " + instruction.toInstructionString());
                    }
