...
public class OutputWriter {
    ...
    public static void generateAsciiImage(String fileName, ParseResultPojo frameData, List<Instructions> instructionsList)
		    throws IOException, IllegalInstructionFound {
